...
public class Candidate extends BasicResponse {
	...
	protected Candidate() {
		// Restricts access to end user so they must use a Candidate.Builder to
		// create a Person
	}
	...
	/**
	 * Returns a complete revision history of a candidate's edits. This allows
	 * you to maintain a full audit trail of when and how you update a client's
	 * profile over time. The latest revision is presented at the top of the
	 * list, and the original is at the end of the list.
	 * 
	...
	/**
	 * Performs a watchlist search for this candidate with default search
	 * options. Results may be of entities or individuals.
	 *
	...
	/**
	 * Performs a watchlist search for this candidate with a specified
	 * similarity threshold. Results may be of entities or individuals.
	 *
	 * @param similarityThreshold
	 *            the tolerated similarity threshold
	...
	/**
	 * Performs a watchlist search for this candidate with a specified entity
	 * type. The default similarity threshold is used.
	 *
	 * @param entityType
	 *            the type of entity
	 * @return the paginated watchlist hit results
	 ...
	 *            the type of entity
	 * @param similarityThreshold
	 *            the accepted threshold of similarity
	 * @return the paginated watchlist hit results
	 */
	public PaginatedResult<WatchlistHit> searchWatchlists(EntityType entityType, Double similarityThreshold) {
		...
		// wrap the result's data with PaginatedResult to make v5.0 transition
		// simpler
	...
	/**
	 * You can store additional information about the candidate here such as
	 * your internal system's identifier for this individual. This will allow
	 * you to keep track of them.
	 *
	 * @param note
	 *            the additional information to store.]
	 * @return this
	 */
	@NotNull
	...
	/**
	 * Can be either the last 4 digits of the US Social Security Number or the
	 * whole SSN.
	 *
	 * @param ssn
	 *            the SSN to use
	...
	/**
	 * Sets the passport number of the individual being verified. is only used
	 * for verifying non-US customers.
	 *
	 * @param passport
	 *            the passport number
	 * @return this
	...
	/**
	 * Gets either the 4 digits of the US Social Security Number or the whole
	 * SSN.
	 *
	 * @return the SSN
	 */
	...
	/**
	 * The passport number of the individual being verified. is only used for
	 * verifying non-US customers.
	 *
	...
	public Address getAddress() {
		Address addressObject = new Address(addressStreet1, addressStreet2, addressCity, addressSubdivision,
				addressPostalCode, addressCountryCode);
		return addressObject;
	}

	/**
	 * Sets the internal REST api adapter needed to complete Blockscore API
	 * requests.
	 *
	 * @param restAdapter
	 *            the REST adapter
	...
	public static class Builder {
		...
		/**
		 * You can store additional information about the candidate here such as
		 * your internal system's identifier for this individual. This will
		...
		/**
		 * Can be either the last 4 digits of the US Social Security Number or
		 * the whole SSN.
		 *
		 * @param ssn
		 *            the SSN to use
		...
		/**
		 * Sets the passport number of the individual being verified. is only
		 * used for verifying non-US customers.
		 *
		 * @param passport
		 *            the passport data
		 * @return this
